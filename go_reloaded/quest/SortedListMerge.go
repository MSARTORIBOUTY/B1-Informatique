...
func SortedListMerge(n1 *NodeI, n2 *NodeI) *NodeI {
	//n1 est notre liste
	//n2 correspond aux chiffres à insérer dans n1

	chiffres := n2
	for chiffres != nil {
		// j'appelle ma fonction pour ranger mes listes
		n1 = SortListInsert(n1, chiffres.Data)
		chiffres = chiffres.Next //Pour aficher la suite des caractères
	}
	return n1
